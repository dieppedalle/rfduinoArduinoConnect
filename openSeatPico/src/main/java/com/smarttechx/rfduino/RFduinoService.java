...
public class RFduinoService extends Service {
    ...
    public final static UUID UUID_SERVICE = BluetoothHelper.sixteenBitUuid(0x3000);
    public final static UUID UUID_RECEIVE = BluetoothHelper.sixteenBitUuid(0x3001);
    public final static UUID UUID_SEND = BluetoothHelper.sixteenBitUuid(0x3002);
    public final static UUID UUID_DISCONNECT = BluetoothHelper.sixteenBitUuid(0x3003);
    public final static UUID UUID_CLIENT_CONFIGURATION = BluetoothHelper.sixteenBitUuid(0x2902);
    // NEW
