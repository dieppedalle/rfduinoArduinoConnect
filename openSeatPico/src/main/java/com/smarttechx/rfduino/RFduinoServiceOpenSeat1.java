 ...
 */
public class RFduinoServiceOpenSeat1 extends Service {
    private final static String TAG = RFduinoServiceOpenSeat1.class.getSimpleName();
    ...
    public class LocalBinder extends Binder {
        RFduinoServiceOpenSeat1 getService() {
            return RFduinoServiceOpenSeat1.this;
        }
    }
