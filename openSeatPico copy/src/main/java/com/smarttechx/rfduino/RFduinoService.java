...
public class RFduinoService extends Service {
    ...
    // Gauthier
    public final static UUID UUID_SERVICE2 = BluetoothHelper.sixteenBitUuid(0x2220);
    public final static UUID UUID_RECEIVE2 = BluetoothHelper.sixteenBitUuid(0x2221);
    public final static UUID UUID_SEND2 = BluetoothHelper.sixteenBitUuid(0x2222);
    public final static UUID UUID_DISCONNECT2 = BluetoothHelper.sixteenBitUuid(0x2223);
    public final static UUID UUID_CLIENT_CONFIGURATION2 = BluetoothHelper.sixteenBitUuid(0x2902);

    public static UUID UUID_SERVICE = BluetoothHelper.sixteenBitUuid(0x3000);
    public static UUID UUID_RECEIVE = BluetoothHelper.sixteenBitUuid(0x3001);
    public static UUID UUID_SEND = BluetoothHelper.sixteenBitUuid(0x3002);
    public static UUID UUID_DISCONNECT = BluetoothHelper.sixteenBitUuid(0x3003);
    public static UUID UUID_CLIENT_CONFIGURATION = BluetoothHelper.sixteenBitUuid(0x2902);

    // NEW
    /*public final static UUID UUID_SERVICE = UUID.fromString("2d63d655-970c-4be7-9deb-3f966537eb2c");
    public final static UUID UUID_RECEIVE = UUID.fromString("2d63d656-970c-4be7-9deb-3f966537eb2c");
    public final static UUID UUID_SEND = UUID.fromString("2d63d657-970c-4be7-9deb-3f966537eb2c");
    public final static UUID UUID_DISCONNECT = UUID.fromString("2d63d658-970c-4be7-9deb-3f966537eb2c");
    public final static UUID UUID_CLIENT_CONFIGURATION = UUID.fromString("2d63d655-970c-4be7-9deb-3f966537eb2d");*/
